...
//if (senderTextBox.Text.StartsWith("+380") == true && senderTextBox.Text.Length == 13)
//    message.SenderNumber = senderTextBox.Text;
//else
//{
//    MessageBox.Show("Неправильний формат номера! Перевірте кількість цифр або спробуйте почати введення з +380", "Помилка");
//    Close();
//}
